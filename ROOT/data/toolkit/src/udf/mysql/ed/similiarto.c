/*
  $Id: SIMILIARTO.c 4068 2008-10-14 01:56:51Z rares $
...
my_bool SIMILIARTO_init(UDF_INIT*, UDF_ARGS*, char*);
void SIMILIARTO_deinit(UDF_INIT*);
longlong SIMILIARTO(UDF_INIT*, UDF_ARGS*, char*, char*);
 ...
 */
longlong SIMILIARTO(UDF_INIT *initid __attribute__((unused)),
...
my_bool SIMILIARTO_init(UDF_INIT *initid, UDF_ARGS *args, char *message)
{
  if (args->arg_count != 3 ||
...
void SIMILIARTO_deinit(UDF_INIT *initid __attribute__((unused)))
{
}
